...
describe('Fluxo de Meus Treinos - GymTracker', () => {
  ...
  it('8. Sugestões: Deve navegar até a aba e clonar um programa de treino com sucesso', async () => {
    ...
    if (deleteBtns.length > 0) {
       ...
       await driver.wait(until.elementLocated(By.xpath("//*[contains(text(), 'Treino excluído')]")), 5000);
    }
  }, 12000);
});